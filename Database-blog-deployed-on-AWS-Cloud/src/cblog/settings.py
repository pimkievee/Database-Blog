...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.ce2bgallfsqq.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'Veebay' # s3 bucket name
AWS_S3_CUSTOM_DOMAIN = '%s.s3.amazonaws.com' % AWS_STORAGE_BUCKET_NAME
AWS_S3_REGION_NAME = "us-east-1" # your s3 region 
